    ...
    <main className="min-h-screen bg-[#FAF8F5] text-[#1E293B] flex flex-col pt-20">
      ...
      <section className="py-10 sm:py-14 bg-gradient-to-b from-[#F4EFEA] to-[#FAF8F5] border-b border-[#E8DFC8]/60">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <div className="pt-3">
            <ScrollDownIndicator targetId="service-selection" label="Find Your Path" />
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-14 bg-[#F4EFEA] border-t border-[#E8DFC8]/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            
            {/* Mentoring Box */}
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#E8DFC8] shadow-xs space-y-4 flex flex-col justify-between">
              ...
              <div className="pt-3">
                <Link
                  href="/mentoring"
                  className="inline-flex items-center gap-2 text-xs sm:text-sm md:text-base font-bold text-[#0B1325] hover:text-[#947124]"
                >
